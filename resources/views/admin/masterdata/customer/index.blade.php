                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title align-items-start flex-column">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" id="searchcustomerTable"
                                class="form-control form-control-solid w-250px ps-15" placeholder="Search..." />
                        </div>
                    </div>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base" id="loading-add">
                            @can('created', ['/admin/masterdata/customer'])
    ...
    <script>
        function infoModal(id) {
            ...
            $.get("{{ url('/admin/masterdata/customer/info') }}/" + id, {}, function(data, status) {
                ...
                $('#loading-add').html(
                    '<button type="button" class="btn btn-primary me-3" id="add-btn" onclick="addModal()">Add Customer</button>'
                    )
            })
        }
        ...
        var customerTable = $('#customerTable').DataTable({
            ...
            processing: true,
            ajax: {
                url: "{{ url('/admin/masterdata/customer/list') }}"
            },
            columns: [{
                    data: 'DT_RowIndex',
                    searchable: false
        ...
        $('#searchcustomerTable').keyup(function() {
