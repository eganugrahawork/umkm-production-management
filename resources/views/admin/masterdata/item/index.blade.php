                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title align-items-start flex-column">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" id="searchitemTable"
                                class="form-control form-control-solid w-250px ps-15" placeholder="Search..." />
                        </div>
                    </div>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base" id="loading-add">
                            @can('created', ['/admin/masterdata/item'])
...
@section('js')
    <script>
        function addModal() {
            ...
            $.get("{{ url('/admin/masterdata/item/create') }}", {}, function(data, status) {
                $('#kontennya').html(data)
                $('#mainmodal').modal('toggle')
                $('#loading-add').html(
                    '<button type="button" class="btn btn-primary me-3" id="add-btn" onclick="addModal()">Add Item</button>'
                    )
            })
        }
        ...
        var itemTable = $('#itemTable').DataTable({
            ...
            processing: true,
            ajax: {
                url: "{{ url('/admin/masterdata/item/list') }}"
            },
            columns: [{
                    data: 'DT_RowIndex',
                    searchable: false
